...
pub struct eqs_labels_t {
    ...
    #[doc = " Names of the variables composing this set of labels. There are `size`\n elements in this array, each being a NULL terminated UTF-8 string."]
    ...
    #[doc = " Number of variables/size of a single entry in the set of labels"]
    pub size: usize,
