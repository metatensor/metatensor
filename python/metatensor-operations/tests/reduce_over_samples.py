...
class TestSumSamples(unittest.TestCase):
    def test_sum_samples_block(self):
        ...
        reduce_tensor_se = metatensor.sum_over_samples(
    ...
    def test_reduction_block_two_samples(self):
        ...
        reduce_X_2 = metatensor.sum_over_samples(
...
class TestMeanSamples(unittest.TestCase):
    def test_mean_samples_block(self):
        ...
        # check both passing a list and a single string for sample_names
        reduce_tensor_se = metatensor.mean_over_samples(
            tensor_se, sample_names="center"
        )
        reduce_tensor_ps = metatensor.mean_over_samples(
    ...
    def test_reduction_block_two_samples(self):
        ...
        reduce_X_2 = metatensor.mean_over_samples(
            X, sample_names=["samples1", "samples3"]
        )
...
class TestReductionAllSamples(unittest.TestCase):
    def test_reduction_allsamples(self):
        ...
        self.assertTrue(metatensor.equal_metadata(sum_X, mean_X))
        self.assertTrue(metatensor.equal_metadata(sum_X, std_X))
        self.assertTrue(metatensor.equal_metadata(mean_X, var_X))
...
class TestStdSamples(unittest.TestCase):
    def test_std_samples_block(self):
        ...
        reduce_tensor_ps = metatensor.std_over_samples(
            tensor_ps, sample_names=["center"]
        )
    ...
    def test_reduction_of_one_element(self):
        ...
        self.assertTrue(metatensor.equal(add_X, mean_X))
        self.assertTrue(metatensor.equal_metadata(add_X, var_X))
        self.assertTrue(metatensor.equal_metadata(mean_X, std_X))

        self.assertTrue(np.all(np.zeros((3, 3)) == std_X[0].values))
        self.assertTrue(metatensor.equal(var_X, std_X))
...
class TestZeroSamples(unittest.TestCase):
    def test_zeros_sample_block(self):
        ...
        self.assertTrue(metatensor.equal(result_tensor, tensor_sum))
        self.assertTrue(metatensor.equal(result_tensor, tensor_mean))
        self.assertTrue(metatensor.equal(result_tensor, tensor_var))
        self.assertTrue(metatensor.equal(result_tensor, tensor_std))
    ...
    def test_zeros_sample_block_gradient(self):
        ...
        self.assertTrue(metatensor.allclose(tensor_sum_result, tensor_sum, atol=1e-14))
        self.assertTrue(metatensor.equal_metadata(tensor_sum, tensor_mean))
        self.assertTrue(metatensor.equal_metadata(tensor_sum, tensor_var))
        self.assertTrue(metatensor.equal_metadata(tensor_sum, tensor_std))
