...
def _mts_array_device_numpy(this, device_ptr):
    device_ptr[0] = DLDeviceC(device_type=_KDLCPU, device_id=0)
...
def _mts_array_device_pytorch(this, device_ptr):
    ...
    if torch_dev.type == "cpu":
        ...
        device_ptr[0] = DLDeviceC(device_type=_KDLCUDA, device_id=torch_dev.index or 0)
    else:
        # For other devices, default to CPU. This could be extended.
        device_ptr[0] = DLDeviceC(device_type=_KDLCPU, device_id=0)
