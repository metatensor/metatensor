...
def test_state_dict_labels(tmpdir):
    ...
    check_state_dict(state_dict["labels"])
    check_state_dict(state_dict["dict"]["labels"])
    check_state_dict(state_dict["list"][0])
    check_state_dict(state_dict["tuple"][0])
    check_state_dict(state_dict["nested"]["dict"][42][0])
    ...
    state_dict = module.state_dict()
    check_state_dict(state_dict["sub_module.labels"])
    check_state_dict(state_dict["sub_module.dict"]["labels"])
    check_state_dict(state_dict["sub_module.list"][0])
    check_state_dict(state_dict["sub_module.tuple"][0])
    check_state_dict(state_dict["sub_module.nested"]["dict"][42][0])
...
def test_state_dict_block():
    ...
    state_dict = module.state_dict()
    check_state_dict(state_dict["block"])
    check_state_dict(state_dict["dict"]["block"])
    check_state_dict(state_dict["list"][0])
    check_state_dict(state_dict["tuple"][0])
    check_state_dict(state_dict["nested"]["dict"][42][0])
    ...
    module = Recursive("test")
    state_dict = module.state_dict()
    check_state_dict(state_dict["sub_module.block"])
    check_state_dict(state_dict["sub_module.dict"]["block"])
    check_state_dict(state_dict["sub_module.list"][0])
    check_state_dict(state_dict["sub_module.tuple"][0])
    check_state_dict(state_dict["sub_module.nested"]["dict"][42][0])
...
def test_state_dict_block_device_dtype(tmpdir):
    ...
    assert state_dict["block"][2].dtype == torch.float32
    assert state_dict["dict"]["block"][2].dtype == torch.float32
    assert state_dict["list"][0][2].dtype == torch.float32
    assert state_dict["tuple"][0][2].dtype == torch.float32
    assert state_dict["nested"]["dict"][42][0][2].dtype == torch.float32
    ...
    assert module.nested["dict"][42][0].dtype == torch.float64
    ...
    assert module.nested["dict"][42][0].dtype == torch.float32
    ...
    for device in DEVICES_TO_TEST:
        ...
        assert state_dict["block"][2].device.type == device
        assert state_dict["dict"]["block"][2].device.type == device
        assert state_dict["list"][0][2].device.type == device
        assert state_dict["tuple"][0][2].device.type == device
        assert state_dict["nested"]["dict"][42][0][2].device.type == device
...
def test_state_dict_tensor(tmpdir):
    ...
    state_dict = module.state_dict()
    check_state_dict(state_dict["tensor"])
    check_state_dict(state_dict["dict"]["tensor"])
    check_state_dict(state_dict["list"][0])
    check_state_dict(state_dict["tuple"][0])
    check_state_dict(state_dict["nested"]["dict"][42][0])
    ...
    module = Recursive("test")
    state_dict = module.state_dict()
    check_state_dict(state_dict["sub_module.tensor"])
    check_state_dict(state_dict["sub_module.dict"]["tensor"])
    check_state_dict(state_dict["sub_module.list"][0])
    check_state_dict(state_dict["sub_module.tuple"][0])
    check_state_dict(state_dict["sub_module.nested"]["dict"][42][0])
...
def test_state_dict_tensorr_device_dtype(tmpdir):
    ...
    state_dict = module.state_dict()
    # check that the state dict records the correct dtype
    assert state_dict["tensor"][2].dtype == torch.float32
    assert state_dict["dict"]["tensor"][2].dtype == torch.float32
    assert state_dict["list"][0][2].dtype == torch.float32
    assert state_dict["tuple"][0][2].dtype == torch.float32
    assert state_dict["nested"]["dict"][42][0][2].dtype == torch.float32
    ...
    for device in DEVICES_TO_TEST:
        ...
        state_dict = module.state_dict()
        # check that the state dict records the correct device
        assert state_dict["tensor"][2].device.type == device
        assert state_dict["dict"]["tensor"][2].device.type == device
        assert state_dict["list"][0][2].device.type == device
        assert state_dict["tuple"][0][2].device.type == device
        assert state_dict["nested"]["dict"][42][0][2].device.type == device
