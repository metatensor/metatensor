...
if (WIN32)
    set(METATENSOR_SHARED_LOCATION ${METATENSOR_PREFIX_DIR}/@BIN_INSTALL_DIR@/@METATENSOR_SHARED_LIB_NAME@)
    set(METATENSOR_IMPLIB_LOCATION ${METATENSOR_PREFIX_DIR}/@LIB_INSTALL_DIR@/@METATENSOR_IMPLIB_NAME@)
else()
    set(METATENSOR_SHARED_LOCATION ${METATENSOR_PREFIX_DIR}/@LIB_INSTALL_DIR@/@METATENSOR_SHARED_LIB_NAME@)
endif()

set(METATENSOR_STATIC_LOCATION ${METATENSOR_PREFIX_DIR}/@LIB_INSTALL_DIR@/@METATENSOR_STATIC_LIB_NAME@)
set(METATENSOR_INCLUDE ${METATENSOR_PREFIX_DIR}/@INCLUDE_INSTALL_DIR@/)
