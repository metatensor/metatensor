...
BenchmarkResult bench_labels_small(std::optional<size_t> n_samples, std::optional<size_t> n_warmup) {
...
BenchmarkResult bench_labels_large(std::optional<size_t> n_samples, std::optional<size_t> n_warmup) {
...
BenchmarkResult bench_labels_large_assume_unique(std::optional<size_t> n_samples, std::optional<size_t> n_warmup) {
...
BenchmarkResult bench_tensor_block(std::optional<size_t> n_samples, std::optional<size_t> n_warmup) {
...
BenchmarkResult bench_tensor_block_large(std::optional<size_t> n_samples, std::optional<size_t> n_warmup) {
...
BenchmarkResult bench_tensor_map(std::optional<size_t> n_samples, std::optional<size_t> n_warmup) {
...
BenchmarkResult bench_tensor_map_large(std::optional<size_t> n_samples, std::optional<size_t> n_warmup) {
...
int main(int argc, const char* argv[]) {
    ...
    try {
        run_benchmarks("C++ API", "cxx", options, benchmarks);
