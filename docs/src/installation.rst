...
.. tab-set::
    ...
    .. tab-item:: Python
        ...
        **Conda**
        ...
        ``metatensor-learn``); and ``metatensor-torch``, which also installs all
        the previous packages and the ``metatensor-torch`` Python package.
    ...
    .. tab-item:: C and C++
        ...
        **Conda**
        ...
        We also provide pre-compiled version of the C and C++ libraries on the
        `conda-forge <https://conda-forge.org/>`_ channel. You can install it with
    ...
    .. tab-item:: TorchScript Python
        ...
        **Conda**
        ...
        You can install the same code as with ``pip install metatensor[torch]``
        using our packages in the `conda-forge <https://conda-forge.org/>`_
        channel.
    ...
    .. tab-item:: TorchScript C++
        ...
        **Conda**
        ...
        We also provide pre-compiled version of the library on the `conda-forge
