...
- :c:func:`mts_block_labels`: get one of the :c:type:`mts_labels_t` associated with this block
- :c:func:`mts_block_data`: get the :c:type:`mts_array_t` containing the values of this block
