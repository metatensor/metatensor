...
- :c:func:`mts_tensormap_keys`: get the keys defined in a tensor map as :c:type:`mts_labels_t`
- :c:func:`mts_tensormap_block_by_id`: get a :c:type:`mts_block_t` in a tensor map from its index
