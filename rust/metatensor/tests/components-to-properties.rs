...
fn one_component() {
    ...
    assert_eq!(properties[2], [0, 2]);
    assert_eq!(properties[3], [1, 0]);
    assert_eq!(properties[4], [1, 1]);
    assert_eq!(properties[5], [1, 2]);
...
fn multiple_components() {
    ...
    assert_eq!(properties[0], [0, 0]);
    assert_eq!(properties[1], [0, 1]);
    assert_eq!(properties[2], [1, 0]);
    assert_eq!(properties[3], [1, 1]);
